...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[6] = float4(0.351191,0.312251,0.272495,1.000000);//Color Tint
	Material.VectorExpressions[7] = float4(0.351191,0.312251,0.272495,0.000000);//(Unknown)
