...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[2] = float4(0.500000,1.000000,0.000000,0.000000);//Specular Intensity Roughness Intensity __SubsurfaceProfile (Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	PixelMaterialInputs.Subsurface = MaterialFloat4(Local19,Material.ScalarExpressions[2].z);
