...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(2.226209,1.000000,1.000000,1.000000);//Tiling Offset V Offset U Normal Intensity
	Material.ScalarExpressions[1] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown) (Unknown) Albedo Tint Intensity Base Metallic
	Material.ScalarExpressions[2] = float4(0.500000,1.000000,0.950997,1.061520);//Specular Intensity Roughness Intensity Displacement Height Displacement Strength
	Material.ScalarExpressions[3] = float4(4.810235,0.049003,0.000000,1000.000000);//Displacement Contrast (Unknown) Distance Offset FadeDistance
	Material.ScalarExpressions[4] = float4(20.000000,20.000000,0.000000,0.000000);//Far Tessellation Near Tessellation (Unknown) (Unknown)
