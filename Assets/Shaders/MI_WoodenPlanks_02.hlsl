...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[3] = float4(0.145834,0.145834,0.145834,1.000000);//Albedo Tint
	Material.VectorExpressions[4] = float4(0.145834,0.145834,0.145834,0.000000);//(Unknown)
	Material.VectorExpressions[5] = float4(0.854166,0.854166,0.854166,1.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(3.589324,1.000000,1.000000,1.000000);//Tiling Offset V Offset U Normal Intensity
	...
	Material.ScalarExpressions[2] = float4(0.500000,1.000000,1.000000,0.368707);//Specular Intensity Roughness Intensity Displacement Height Displacement Strength
	Material.ScalarExpressions[3] = float4(1.000000,0.000000,0.000000,1000.000000);//Displacement Contrast (Unknown) Distance Offset FadeDistance
	Material.ScalarExpressions[4] = float4(20.000000,20.000000,0.000000,0.000000);//Far Tessellation Near Tessellation Offset (Unknown)
