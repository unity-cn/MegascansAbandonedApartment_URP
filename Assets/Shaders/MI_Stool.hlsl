...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[3] = float4(0.285715,0.259125,0.231293,1.000000);//Albedo Tint
	Material.VectorExpressions[4] = float4(0.285715,0.259125,0.231293,0.000000);//(Unknown)
	Material.VectorExpressions[5] = float4(0.714285,0.740875,0.768707,1.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(1.000000,1.000000,1.000000,3.000000);//Tiling Offset V Offset U Normal Intensity
	Material.ScalarExpressions[1] = float4(-2.000000,0.000000,1.000000,0.000000);//(Unknown) (Unknown) Albedo Tint Intensity Base Metallic
	Material.ScalarExpressions[2] = float4(0.500000,1.228033,2.000000,1.000000);//Specular Intensity Roughness Intensity Displacement Height Displacement Strength
