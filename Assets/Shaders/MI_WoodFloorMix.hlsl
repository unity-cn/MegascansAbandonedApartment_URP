...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[8] = float4(0.240328,0.240328,0.240328,1.000000);//Color Overlay
	Material.VectorExpressions[9] = float4(0.240328,0.240328,0.240328,0.000000);//(Unknown)
	Material.VectorExpressions[10] = float4(0.759672,0.759672,0.759672,1.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(1.000000,5.000000,1.000000,1.000000);//G Normal Intensity Tiling Base Normal Intensity R Normal Intensity
	...
	Material.ScalarExpressions[2] = float4(1.000000,0.000000,0.000000,0.000000);//R Roughness Intensity Displacement Offset (Unknown) Base Subdivisions
