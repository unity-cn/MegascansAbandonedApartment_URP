...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.169643,0.169643,0.169643,1.000000);//Color Overlay
	Material.VectorExpressions[3] = float4(0.169643,0.169643,0.169643,0.000000);//(Unknown)
	Material.VectorExpressions[4] = float4(0.830357,0.830357,0.830357,1.000000);//(Unknown)
	Material.VectorExpressions[5] = float4(1.000000,1.000000,1.000000,1.000000);//SSS Color Tint
	...
	Material.ScalarExpressions[1] = float4(1.000000,0.787754,1.000000,1.000000);//Overlay Intensity Roughness Intensity Opacity Intensity SSS Color Intensity
	Material.ScalarExpressions[2] = float4(0.000000,0.000000,0.000000,0.000000);//__SubsurfaceProfile (Unknown) (Unknown) (Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat4 Local38 = ProcessMaterialColorTextureLookup(Texture2DSample(Material_Texture2D_4, GetMaterialSharedSampler(Material_Texture2D_4Sampler,View.MaterialTextureBilinearWrapedSampler),Parameters.TexCoords[0].xy));
	MaterialFloat Local39 = MaterialStoreTexSample(Parameters, Local38, 2);
	MaterialFloat3 Local40 = (Local38.rgb * Material.ScalarExpressions[1].w);
	MaterialFloat3 Local41 = (Local40 * Material.VectorExpressions[6].rgb);
	MaterialFloat3 Local42 = min(max(Local41,MaterialFloat3(0.00000000,0.00000000,0.00000000)),MaterialFloat3(1.00000000,1.00000000,1.00000000));
	...
	PixelMaterialInputs.Subsurface = MaterialFloat4(Local42,Material.ScalarExpressions[2].x);
