...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[1] = float4(1.000000,1.000000,1.000000,0.500000);//Overlay Intensity Roughness Intensity Opacity Intensity Wind Speed
	Material.ScalarExpressions[2] = float4(0.000000,0.100000,0.050000,1.000000);//Additional WPO Wind Height Wind Intensity SSS Color Intensity
