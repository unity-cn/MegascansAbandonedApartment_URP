Shader "Quixel/touchController_mat"
{
    Properties
    {
		...
		Material_Texture2D_0( "touchController_albedo", 2D ) = "white" {}
		Material_Texture2D_1( "touchController_controlmap", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "touchController_mat.hlsl"
