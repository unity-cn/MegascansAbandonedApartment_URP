...
//{
	//samplers start
			...
			uniform SamplerState Material_TextureCube_0Sampler;
...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[1] = float4(1.000000,1.000000,1.000000,1.000000);//HDRI_Tint
	...
	Material.ScalarExpressions[0] = float4(-0.776807,-4.880823,1.000000,10000.000000);//CubemapRotation (Unknown) HDRI_Contrast HDRI_Brightness
	Material.ScalarExpressions[1] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown) (Unknown) (Unknown) (Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local0 = RotateAboutAxis(MaterialFloat4(MaterialFloat3(0.00000000,0.00000000,1.00000000),Material.ScalarExpressions[0].y),MaterialFloat3(0.00000000,0.00000000,0.00000000),GetWorldPosition(Parameters));
	MaterialFloat3 Local1 = (Local0 + GetWorldPosition(Parameters));
	MaterialFloat Local2 = dot(Local1, Local1);
	MaterialFloat Local3 = sqrt(Local2);
	MaterialFloat3 Local4 = (Local1 / Local3);
	MaterialFloat Local5 = MaterialStoreTexCoordScale(Parameters, Local4, 0);
	MaterialFloat4 Local6 = ProcessMaterialColorTextureLookup(TextureCubeSample(Material_TextureCube_0, Material_TextureCube_0Sampler,Local4));
	MaterialFloat Local7 = MaterialStoreTexSample(Parameters, Local6, 0);
	MaterialFloat3 Local8 = PositiveClampedPow(Local6.rgb,Material.ScalarExpressions[0].z);
	MaterialFloat3 Local9 = (Local8 * Material.ScalarExpressions[0].w);
	MaterialFloat3 Local10 = (Local9 * Material.VectorExpressions[2].rgb);
	MaterialFloat3 Local11 = lerp(Local10,Material.VectorExpressions[3].rgb,MaterialFloat(Material.ScalarExpressions[1].x));
