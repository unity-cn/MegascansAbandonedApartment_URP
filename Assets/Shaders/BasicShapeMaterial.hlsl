...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(1.000000,1.000000,1.000000,1.000000);//Color
	Material.VectorExpressions[3] = float4(1.000000,1.000000,1.000000,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(0.000000,0.640700,0.000000,0.000000);//(Unknown) Roughness (Unknown) (Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	PixelMaterialInputs.Roughness = Material.ScalarExpressions[0].y;
