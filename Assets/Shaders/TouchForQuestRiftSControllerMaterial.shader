Shader "Quixel/TouchForQuestRiftSControllerMaterial"
{
    Properties
    {
		...
		Material_Texture2D_0( "TouchForQuestRiftSController_albedo", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "TouchForQuestRiftSControllerMaterial.hlsl"
