...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[1] = float4(0.000000,0.000000,8.764892,1.000000);//(Unknown) (Unknown) Albedo Tint Intensity Metalness Intensity
	Material.ScalarExpressions[2] = float4(0.500000,4.000000,2.000000,1.000000);//Specular Intensity Roughness Intensity Displacement Height Displacement Strength
...
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat4 Local21 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2, Material_Texture2D_2Sampler,Local1,View.MaterialTextureMipBias));
	...
	MaterialFloat Local24 = MaterialStoreTexCoordScale(Parameters, Local1, 2);
	MaterialFloat4 Local25 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_3, Material_Texture2D_3Sampler,Local1,View.MaterialTextureMipBias));
	MaterialFloat Local26 = MaterialStoreTexSample(Parameters, Local25, 2);
	MaterialFloat Local27 = (Local25.r * Material.ScalarExpressions[2].y);

	PixelMaterialInputs.EmissiveColor = Local6;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local19;
	PixelMaterialInputs.Metallic = Local23;
	PixelMaterialInputs.Specular = Material.ScalarExpressions[2].x;
	PixelMaterialInputs.Roughness = Local27;
