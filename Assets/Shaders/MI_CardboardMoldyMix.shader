Shader "Quixel/MI_CardboardMoldyMix"
{
    Properties
    {
		...
		Material_Texture2D_0( "G Normal", 2D ) = "white" {}
		Material_Texture2D_1( "Base Normal", 2D ) = "white" {}
		Material_Texture2D_2( "R Normal", 2D ) = "white" {}
		Material_Texture2D_3( "G Albedo", 2D ) = "white" {}
		Material_Texture2D_4( "Base Albedo", 2D ) = "white" {}
		Material_Texture2D_5( "R Albedo", 2D ) = "white" {}
		Material_Texture2D_6( "G Roughness", 2D ) = "white" {}
		Material_Texture2D_7( "Base Roughness", 2D ) = "white" {}
		Material_Texture2D_8( "R Roughness", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_CardboardMoldyMix.hlsl"
    ...
    SubShader
    {
        ...
        SurfaceDescription SurfaceDescriptionFunction( SurfaceDescriptionInputs IN )
        {
            ...
            In.viewDir = float3( 0, 0, 1 );// GetWorldSpaceViewDir( IN.WorldSpacePosition );
            In.screenPos = float4( 0, 0, 0, 0 );
            In.worldPos = float3( 0, 0, 0 ); //IN.WorldSpacePosition;
            In.normal2 = float3( 0, 0, 1 );
