...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[3] = float4(1.000000,1.000000,1.000000,1.000000);//Albedo Tint
	Material.VectorExpressions[4] = float4(1.000000,1.000000,1.000000,0.000000);//(Unknown)
	Material.VectorExpressions[5] = float4(0.000000,0.000000,0.000000,1.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(1.000000,1.000000,1.000000,2.000000);//Tiling Offset V Offset U Normal Intensity
	Material.ScalarExpressions[1] = float4(-1.000000,0.000000,0.000000,1.414981);//(Unknown) (Unknown) Albedo Tint Intensity Speed
	Material.ScalarExpressions[2] = float4(1.000000,0.000000,0.000000,0.500000);//NoiseScale Visualize Wind Color Base Metallic Specular Intensity
	Material.ScalarExpressions[3] = float4(1.000000,0.650000,7.110703,2.000000);//Roughness Intensity Opacity Strength Displacement Height
	Material.ScalarExpressions[4] = float4(0.443300,1.000000,-1.000000,0.000000);//Displacement Strength Displacement Contrast (Unknown) Distance Offset
	Material.ScalarExpressions[5] = float4(1000.000000,20.000000,20.000000,0.000000);//FadeDistance Far Tessellation Near Tessellation __SubsurfaceProfile
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local20 = (Material.ScalarExpressions[1].w * View.GameTime);
	MaterialFloat Local21 = (Local20 * 0.10000000);
	MaterialFloat2 Local22 = (Parameters.TexCoords[0].xy * Material.ScalarExpressions[2].x);
	MaterialFloat2 Local23 = (MaterialFloat2(Local21,Local21) + Local22);
	MaterialFloat Local24 = MaterialStoreTexCoordScale(Parameters, Local23, 8);
	MaterialFloat4 Local25 = ProcessMaterialLinearGreyscaleTextureLookup((Texture2DSampleBias(Material_Texture2D_2, Material_Texture2D_2Sampler,Local23,View.MaterialTextureMipBias)).r).rrrr;
	MaterialFloat Local26 = MaterialStoreTexSample(Parameters, Local25, 8);
	MaterialFloat Local27 = (Local20 * -0.10000000);
	MaterialFloat2 Local28 = (Local22 + MaterialFloat2(0.41810000,0.35479999));
	MaterialFloat2 Local29 = (MaterialFloat2(Local27,Local27) + Local28);
	MaterialFloat Local30 = MaterialStoreTexCoordScale(Parameters, Local29, 8);
	MaterialFloat4 Local31 = ProcessMaterialLinearGreyscaleTextureLookup((Texture2DSampleBias(Material_Texture2D_2, Material_Texture2D_2Sampler,Local29,View.MaterialTextureMipBias)).r).rrrr;
	MaterialFloat Local32 = MaterialStoreTexSample(Parameters, Local31, 8);
	MaterialFloat3 Local33 = (Local25.rgb + Local31.rgb);
	MaterialFloat2 Local34 = (Local22 + MaterialFloat2(0.86486101,0.14838400));
	MaterialFloat2 Local35 = (MaterialFloat2(Local27,Local21) + Local34);
	MaterialFloat Local36 = MaterialStoreTexCoordScale(Parameters, Local35, 8);
	MaterialFloat4 Local37 = ProcessMaterialLinearGreyscaleTextureLookup((Texture2DSampleBias(Material_Texture2D_2, Material_Texture2D_2Sampler,Local35,View.MaterialTextureMipBias)).r).rrrr;
	MaterialFloat Local38 = MaterialStoreTexSample(Parameters, Local37, 8);
	MaterialFloat2 Local39 = (Local22 + MaterialFloat2(0.65134001,0.75163800));
	MaterialFloat2 Local40 = (MaterialFloat2(Local21,Local27) + Local39);
	MaterialFloat Local41 = MaterialStoreTexCoordScale(Parameters, Local40, 8);
	MaterialFloat4 Local42 = ProcessMaterialLinearGreyscaleTextureLookup((Texture2DSampleBias(Material_Texture2D_2, Material_Texture2D_2Sampler,Local40,View.MaterialTextureMipBias)).r).rrrr;
	MaterialFloat Local43 = MaterialStoreTexSample(Parameters, Local42, 8);
	MaterialFloat3 Local44 = (Local37.rgb + Local42.rgb);
	MaterialFloat3 Local45 = (Local33 + Local44);
	MaterialFloat3 Local46 = (Local45 * 0.25000000);
	MaterialFloat3 Local47 = lerp(MaterialFloat3(1.00000000,0.00000000,0.00000000),Local46,MaterialFloat3(0.00000000,1.00000000,0.00000000));
	MaterialFloat3 Local48 = lerp(Local19,Local47,MaterialFloat(Material.ScalarExpressions[2].y));
	MaterialFloat Local49 = MaterialStoreTexCoordScale(Parameters, Local1, 0);
	MaterialFloat4 Local50 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_3, Material_Texture2D_3Sampler,Local1,View.MaterialTextureMipBias));
	MaterialFloat Local51 = MaterialStoreTexSample(Parameters, Local50, 0);
	MaterialFloat Local52 = (Local50.r * Material.ScalarExpressions[3].x);
	MaterialFloat Local53 = MaterialStoreTexCoordScale(Parameters, Parameters.TexCoords[0].xy, 0);
	MaterialFloat4 Local54 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_4, Material_Texture2D_4Sampler,Parameters.TexCoords[0].xy,View.MaterialTextureMipBias));
	MaterialFloat Local55 = MaterialStoreTexSample(Parameters, Local54, 0);

	PixelMaterialInputs.EmissiveColor = Local6;
	PixelMaterialInputs.Opacity = Material.ScalarExpressions[3].y;
	PixelMaterialInputs.OpacityMask = Local54.r;
	PixelMaterialInputs.BaseColor = Local48;
	PixelMaterialInputs.Metallic = Material.ScalarExpressions[2].z;
	PixelMaterialInputs.Specular = Material.ScalarExpressions[2].w;
	PixelMaterialInputs.Roughness = Local52;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = MaterialFloat4(Local19,Material.ScalarExpressions[5].w);
