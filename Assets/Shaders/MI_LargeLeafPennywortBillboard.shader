Shader "Quixel/MI_LargeLeafPennywortBillboard"
{
    Properties
    {
		...
		Material_Texture2D_3( "Opacity", 2D ) = "white" {}
		Material_Texture2D_4( "Translucency", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_LargeLeafPennywortBillboard.hlsl"
