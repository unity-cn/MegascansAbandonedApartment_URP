Shader "Quixel/MI_WindowStain_01"
{
    Properties
    {
		...
		Material_Texture2D_0( "Roughness", 2D ) = "white" {}

        View_BufferSizeAndInvSize( "View_BufferSizeAndInvSize", Vector ) = ( 1920,1080,0.00052, 0.00092 )//1920,1080,1/1920, 1/1080
    }
    SubShader
    {
        //BLEND_OFF Tags { "RenderPipeline"="UniversalPipeline" "RenderType"="Opaque" "UniversalMaterialType" = "Lit" "Queue"="Geometry" }
        ...
        #include "MI_WindowStain_01.hlsl"
