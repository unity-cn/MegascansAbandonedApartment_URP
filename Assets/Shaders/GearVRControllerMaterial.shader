Shader "Quixel/GearVRControllerMaterial"
{
    Properties
    {
		...
		Material_Texture2D_0( "GearVRController_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "GearVRController_Color", 2D ) = "white" {}
		Material_Texture2D_2( "GearVRController_AO", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "GearVRControllerMaterial.hlsl"
