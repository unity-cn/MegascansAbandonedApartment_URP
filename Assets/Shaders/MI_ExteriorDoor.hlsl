...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[3] = float4(0.220239,0.220239,0.220239,1.000000);//Albedo Tint
	Material.VectorExpressions[4] = float4(0.220239,0.220239,0.220239,0.000000);//(Unknown)
	Material.VectorExpressions[5] = float4(0.779761,0.779761,0.779761,1.000000);//(Unknown)
	...
	Material.ScalarExpressions[2] = float4(0.500000,1.485169,0.000000,0.000000);//Specular Intensity Roughness Intensity (Unknown) (Unknown)
