Shader "Quixel/MI_MicrosoftMixedReality"
{
    Properties
    {
		...
		Material_Texture2D_0( "NormalTexture", 2D ) = "white" {}
		Material_Texture2D_1( "EmissiveTexture", 2D ) = "white" {}
		Material_Texture2D_2( "BaseTexture", 2D ) = "white" {}
		Material_Texture2D_3( "MRTexture", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_MicrosoftMixedReality.hlsl"
