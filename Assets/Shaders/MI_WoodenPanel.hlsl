...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[3] = float4(0.208334,0.208334,0.208334,1.000000);//Albedo Tint
	Material.VectorExpressions[4] = float4(0.208334,0.208334,0.208334,0.000000);//(Unknown)
	Material.VectorExpressions[5] = float4(0.791666,0.791666,0.791666,1.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(5.000000,1.000000,1.000000,1.000000);//Tiling Offset V Offset U Normal Intensity
	...
	Material.ScalarExpressions[2] = float4(0.500000,1.000000,3.175427,1.000000);//Specular Intensity Roughness Intensity Displacement Height Displacement Strength
	Material.ScalarExpressions[3] = float4(1.000000,-2.175427,0.470899,1000.000000);//Displacement Contrast (Unknown) Distance Offset FadeDistance
