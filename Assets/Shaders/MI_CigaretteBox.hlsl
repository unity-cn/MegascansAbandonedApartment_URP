...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[1] = float4(0.000000,0.000000,-0.485714,0.000000);//(Unknown) (Unknown) Albedo Tint Intensity Base Metallic
	Material.ScalarExpressions[2] = float4(0.500000,1.000000,0.000000,0.000000);//Specular Intensity Roughness Intensity (Unknown) (Unknown)
