...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.500000,0.500000,0.500000,1.000000);//Color
	Material.VectorExpressions[3] = float4(0.500000,0.500000,0.500000,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(0.000000,1.000000,1.000000,0.100000);//(Unknown) Metallic Specular Roughness
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat4 Local2 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_0, Material_Texture2D_0Sampler,Parameters.TexCoords[0].xy,View.MaterialTextureMipBias));
	MaterialFloat Local3 = MaterialStoreTexSample(Parameters, Local2, 0);
	MaterialFloat3 Local4 = (Local2.rgb * Material.ScalarExpressions[0].w);

	PixelMaterialInputs.EmissiveColor = Local0;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Material.VectorExpressions[3].rgb;
	PixelMaterialInputs.Metallic = Material.ScalarExpressions[0].y;
	PixelMaterialInputs.Specular = Material.ScalarExpressions[0].z;
	PixelMaterialInputs.Roughness = Local4;
