...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[6] = float4(0.574405,0.529026,0.455421,1.000000);//Color Tint
	Material.VectorExpressions[7] = float4(0.574405,0.529026,0.455421,0.000000);//(Unknown)
