...
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local5 = (Local3.rgb * MaterialFloat3(0.30000001,0.30000001,1.00000000));
	...
	MaterialFloat3 Local6 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Material.VectorExpressions[1].rgb,MaterialFloat(Material.ScalarExpressions[0].x));
	MaterialFloat2 Local7 = (Parameters.TexCoords[0].xy * 20.00000000);
	MaterialFloat Local8 = MaterialStoreTexCoordScale(Parameters, Local7, 0);
	MaterialFloat4 Local9 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1, Material_Texture2D_1Sampler,Local7,View.MaterialTextureMipBias));
	MaterialFloat Local10 = MaterialStoreTexSample(Parameters, Local9, 0);
	MaterialFloat Local11 = lerp(0.40000001,1.00000000,Local9.r);
	MaterialFloat Local12 = (1.00000000 - Local11);
	MaterialFloat2 Local13 = (Local0 / 0.10000000);
	MaterialFloat Local14 = MaterialStoreTexCoordScale(Parameters, Local13, 0);
	MaterialFloat4 Local15 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1, Material_Texture2D_1Sampler,Local13,View.MaterialTextureMipBias));
	MaterialFloat Local16 = MaterialStoreTexSample(Parameters, Local15, 0);
	MaterialFloat Local17 = (GetPixelDepth(Parameters).r - 24.00000000);
	MaterialFloat Local18 = (Local17 / 1500.00000000);
	MaterialFloat Local19 = min(max(Local18,0.00000000),1.00000000);
	MaterialFloat Local20 = lerp(Local15.g,1.00000000,Local19);
	MaterialFloat Local21 = lerp(Local11,Local12,Local20);
	MaterialFloat Local22 = MaterialStoreTexCoordScale(Parameters, Local0, 0);
	MaterialFloat4 Local23 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1, Material_Texture2D_1Sampler,Local0,View.MaterialTextureMipBias));
	MaterialFloat Local24 = MaterialStoreTexSample(Parameters, Local23, 0);
	MaterialFloat Local25 = lerp(Local15.g,0.00000000,Local19);
	MaterialFloat Local26 = (Local23.g + Local25);
	MaterialFloat Local27 = lerp(Local26.r,0.50000000,0.50000000);
	MaterialFloat Local28 = lerp(0.29499999,0.66000003,Local27);
	MaterialFloat Local29 = (Local28 * 0.50000000);
	MaterialFloat Local30 = (Local21 * Local29);
	MaterialFloat Local31 = lerp(0.00000000,0.50000000,Local23.g);
	MaterialFloat Local32 = lerp(0.69999999,1.00000000,Local15.g);
	MaterialFloat Local33 = lerp(Local32,1.00000000,Local19);
	MaterialFloat Local34 = (Local33 * 1.00000000);
	MaterialFloat Local35 = (Local31 + Local34);
