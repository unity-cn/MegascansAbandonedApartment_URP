...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[3] = float4(0.091518,0.091518,0.091518,1.000000);//Albedo Tint
	Material.VectorExpressions[4] = float4(0.091518,0.091518,0.091518,0.000000);//(Unknown)
	Material.VectorExpressions[5] = float4(0.908482,0.908482,0.908482,1.000000);//(Unknown)
	...
	Material.ScalarExpressions[2] = float4(0.500000,0.439455,0.000000,0.000000);//Specular Intensity Roughness Intensity (Unknown) (Unknown)
