...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(1.052363,1.000000,1.000000,1.000000);//Tiling Offset V Offset U Normal Intensity
	...
	Material.ScalarExpressions[4] = float4(0.000000,0.000000,0.270748,0.270748);//Far Tessellation Near Tessellation Offset (Unknown)
