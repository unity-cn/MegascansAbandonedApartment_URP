...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(14.360120,1.000000,1.000000,1.000000);//Tiling Offset V Offset U Normal Intensity
	...
	Material.ScalarExpressions[4] = float4(0.000000,0.000000,0.462677,0.462677);//Far Tessellation Near Tessellation Offset (Unknown)
