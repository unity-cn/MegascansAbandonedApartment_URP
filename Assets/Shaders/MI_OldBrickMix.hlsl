...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[3] = float4(0.243304,0.243304,0.243304,1.000000);//Albedo Tint
	Material.VectorExpressions[4] = float4(0.243304,0.243304,0.243304,0.000000);//(Unknown)
	Material.VectorExpressions[5] = float4(0.756696,0.756696,0.756696,1.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(7.550000,1.000000,1.000000,1.000000);//Tiling Offset V Offset U Normal Intensity
	...
	Material.ScalarExpressions[2] = float4(0.500000,1.000000,1.099131,0.966844);//Specular Intensity Roughness Intensity Displacement Height Displacement Strength
	Material.ScalarExpressions[3] = float4(2.706168,-0.099131,0.000000,1000.000000);//Displacement Contrast (Unknown) Distance Offset FadeDistance
	Material.ScalarExpressions[4] = float4(20.000000,20.000000,2.033883,2.033883);//Far Tessellation Near Tessellation Offset (Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	PixelMaterialInputs.PixelDepthOffset = Material.ScalarExpressions[4].w;
