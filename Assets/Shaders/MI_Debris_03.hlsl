...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[6] = float4(0.571429,0.509991,0.434399,1.000000);//Color Tint
	Material.VectorExpressions[7] = float4(0.571429,0.509991,0.434399,0.000000);//(Unknown)
